...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 1,
      consts: [[1, "header-image"], [1, "main-title"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_5__["ListComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _starships_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./starships.service */
    ...
    function ListComponent_div_0_div_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ListComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_4_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r4.requestStarships("cargoCapacity_DESC");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r6.requestStarships("costInCredits_DESC");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_10_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.requestStarships("crew_DESC");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_13_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r8.requestStarships("hyperdriveRating_DESC");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_16_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r9.requestStarships("length_DESC");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_19_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.requestStarships("maxAtmospheringSpeed_DESC");
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_div_0_Template_input_click_22_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r11.requestStarships("passengers_DESC");
        });
    ...
    function () {
      ...
      _createClass(ListComponent, [{
        ...
        key: "requestStarships",
        value: function requestStarships(orderCriteria) {
          var _this = this;

          this.json.getJson('https://swapi-graphql.netlify.app/.netlify/functions/index', orderCriteria).subscribe({
            next: function next(starships) {
              if (starships === undefined || starships === null || starships.data === undefined || starships.data === null || starships.data.allStarships.starships.length === 0) {
                _this.error = true;
              } else {
                var allStarships = starships.data.allStarships.starships;

                _this.setShipAttribute(orderCriteria);

                var maxValue = _this.maxAttributeValueByShipAttribute(_this.shipAttribute, allStarships);

                _this.ships = allStarships.map(function (ship) {
                  var attribute = _this.getAttributeValue(ship);

                  return {
                    name: ship.name,
                    percentage: _this.getPercentageProgressValue(maxValue, attribute),
        ...
        key: "setShipAttribute",
        value: function setShipAttribute(orderCriteria) {
        ...
        key: "maxAttributeValueByShipAttribute",
        value: function maxAttributeValueByShipAttribute(shipAttribute, ships) {
          return Math.max.apply(Math, ships.map(function (ship) {
        ...
        value: function getAttributeValue(ship) {
        ...
        key: "getPercentageProgressValue",
        value: function getPercentageProgressValue(maxValue, attributeValue) {
    ...
    ListComponent.ɵfac = function ListComponent_Factory(t) {
      return new (t || ListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_starships_service__WEBPACK_IMPORTED_MODULE_1__["StarshipsService"]));
    };
    ...
    ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 2,
      consts: [["class", "content", 4, "ngIf"], ["class", "error-content", 4, "ngIf"], [1, "content"], [1, "center-content"], ["data-toggle", "buttons", 1, "btn-group", "btn-group-toggle"], [1, "btn", "btn-secondary", "active"], ["type", "radio", "name", "options", "id", "option1", 3, "click"], [1, "btn", "btn-secondary"], ["type", "radio", "name", "options", "id", "option2", 3, "click"], ["type", "radio", "name", "options", "id", "option3", 3, "click"], ["type", "radio", "name", "options", "id", "option4", "checked", "", 3, "click"], ["type", "radio", "name", "options", "id", "option5", 3, "click"], ["type", "radio", "name", "options", "id", "option6", 3, "click"], ["type", "radio", "name", "options", "id", "option7", 3, "click"], ["class", "container progress-background", 4, "ngFor", "ngForOf"], [1, "container", "progress-background"], [1, "progress-name"], [1, "progress"], ["role", "progressbar", "aria-valuenow", "90", "aria-valuemin", "0", "aria-valuemax", "7400", 1, "progress-bar"], [1, "right", "attribute-value"], [1, "error-content"], [1, "error-message"], [1, "error-image"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterOutlet"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListComponent, [{
        ...
        return [{
          type: _starships_service__WEBPACK_IMPORTED_MODULE_1__["StarshipsService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppListStarshipsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "StarshipsService", function () {
    ...
    var StarshipsService =
    /*#__PURE__*/
    function () {
      function StarshipsService(http) {
        _classCallCheck(this, StarshipsService);
      ...
      _createClass(StarshipsService, [{
        key: "getJson",
        value: function getJson(url, orderCriteria) {
    ...
    StarshipsService.ɵfac = function StarshipsService_Factory(t) {
      return new (t || StarshipsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    StarshipsService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: StarshipsService,
      factory: StarshipsService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StarshipsService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/alberto.deavila/workspace/alba-gomez-starwars/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
